...
TASKS = [
    {
        ...
        "expected_sources": ["README.md", "docs/architecture/API.md", "docs/architecture/ARCHITECTURE.md"],
    ...
    },
    {
        ...
        "expected_sources": [
            ...
            "docs/project/AGENT_PROJECT_ROADMAP.md",
        ],
    ...
    },
    {
        ...
        "expected_sources": [
            ...
            "docs/getting-started/Tech_Stack_Knowledge_Base.md",
            "docs/project/AGENT_PROJECT_ROADMAP.md",
        ],

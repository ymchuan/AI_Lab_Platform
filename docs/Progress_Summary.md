...
| 新设备目前只接入 embedding | 多节点路由 v1 已完成，但 Reranker/VL/第二代码模型未接入 | 先补真实 RAG retrieval benchmark，再扩展 Reranker/VL |
...
2. 基于新设备 `embed-local` 构建真实 RAG retrieval benchmark：文档 ingestion、chunk、embedding、向量库、引用回答。

...
| 设备 | GPU / 加速器 | 内存 | 当前状态 |
|------|-------------|------|---------|
| 5090 | RTX 5090 32GB + AMD Radeon 610M | 93.7GB | ✅ 已接入 LM Studio，多模型评测中；Qwen3-Coder-30B 是当前最强 Agent 候选 |
...
LiteLLM (API Key + 模型路由)
    ↓ SSH :12340
5090 LM Studio -> 本地候选模型池（当前 Qwen3-Coder-30B 最适合作为 qwen-agent 候选）
```

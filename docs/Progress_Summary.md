...
**当前 5090 默认 `qwen-agent` 定为 Qwen3-Coder-30B；`embed-local` 已支撑 RAG Service v1；后续 benchmark 重点转向真实工具调用、RAG answer faithfulness、rerank 和多节点路由。**
...
4. 接入新设备后续模型：Reranker、Qwen3 VL 30B / 8B 对照、第二代码模型。

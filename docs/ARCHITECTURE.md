...
- 新设备硬件已校准为 RTX 5080 16GB + RTX 4060 Ti 16GB + AMD 集显 + 61.4GB RAM，尚未部署模型、隧道或 LiteLLM 路由。
...
│ - 模型别名路由：qwen-agent / qwen-think / embed-local 待按最终选型校准 │
│ - systemd 后台运行 + 崩溃重启                                  │
│                                                              │
│ SSH Reverse Tunnels                                          │
...
新设备 (RTX 5080 16GB)      -> 第二推理节点 / VL / 中等代码模型 / Reranker
...
5. LiteLLM 路由到 qwen-local / qwen-agent 后端

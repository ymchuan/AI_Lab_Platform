...
- RAG v0 已完成：`services/rag` 使用项目 Markdown 文档、`embed-local`、本地 JSON 向量索引和 `qwen-agent`，实现检索与带引用回答。下一步升级为本地常驻 RAG Service，而不是部署到 2GB 云服务器。
...
- [ ] RAG Service v1：向量数据库、reranker、API Server、answer eval
- [ ] Agent 开发框架
- [ ] MCP Server
- [ ] Skills / Tools 插件体系

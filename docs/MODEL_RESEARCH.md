...
| 8060S | AMD Ryzen AI MAX+ 395 / Radeon 8060S / NPU | 31.6GB | 已恢复为可规划候选节点，未接入 LiteLLM / `:12342` / benchmark | 候选 brain / 文档处理 / rerank / 轻量服务节点 |
...
8. 每轮结果写入 `docs/BENCHMARK_RESULTS.md`，并更新 `README.md` / `HANDOFF.md` / `CHANGELOG.md`。
